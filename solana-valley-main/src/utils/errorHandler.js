...
export const handleContractError = (error, context = "") => {
  ...
  if (
    errorMessage.includes("Failed to initialize request") &&
  ...
  if (errorMessage.includes("revert")) {
    ...
    if (revertMessage.includes("Insufficient") || revertMessage.includes("insufficient")) {
      if (
        revertMessage.includes("potato") ||
        revertMessage.includes("lettuce") ||
        revertMessage.includes("cabbage") ||
        revertMessage.includes("radish") ||
        revertMessage.includes("onion") ||
        revertMessage.includes("grapes") ||
        revertMessage.includes("berry") ||
        revertMessage.includes("cauliflower") ||
        revertMessage.includes("dragonfruit") ||
        revertMessage.includes("lavender") ||
        revertMessage.includes("lychee") ||
        revertMessage.includes("wheat") ||
        revertMessage.includes("tomato") ||
        revertMessage.includes("carrot") ||
        revertMessage.includes("corn") ||
        revertMessage.includes("pumpkin") ||
        revertMessage.includes("chili") ||
        revertMessage.includes("parsnap") ||
        revertMessage.includes("celery") ||
        revertMessage.includes("broccoli") ||
        revertMessage.includes("banana") ||
        revertMessage.includes("mango") ||
        revertMessage.includes("avocado") ||
        revertMessage.includes("pineapple") ||
        revertMessage.includes("blueberry") ||
        revertMessage.includes("artichoke") ||
        revertMessage.includes("papaya") ||

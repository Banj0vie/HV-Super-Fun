...
export function getMultiplier(subType, level) {
  switch (subType) {
    // Common
    case 1:
      return 500 + (level - 1) * 6;
    // Uncommon
    case 2:
      return 600 + (level - 1) * 6;
    // Rare
    case 3:
      return 700 + (level - 1) * 6;
    // Epic
    case 4:
      return 800 + (level - 1) * 6;
    // Legendary
    case 5:
      return 900 + (level - 1) * 6;
    // Default fallback
    default:
      return 500;
  }
...
export const SAGE_UNLOCK_COOLDOWN = 2 * 60; // EPOCH_PERIOD (ms)
...
export const chestLootTable = chestType => {
  ...
  switch (chestId) {
    case ID_CHEST_ITEMS.CHEST_WOOD: // CHEST_WOOD
      return [...picoProduce, ...feebleSeeds, ...picoSeeds];
    case ID_CHEST_ITEMS.CHEST_BRONZE: // CHEST_BRONZE
      return [...picoProduce, growth, pesticide, ...feebleSeeds, ...picoSeeds, ...basicSeeds];
    case ID_CHEST_ITEMS.CHEST_SILVER: // CHEST_SILVER
      return [...basicProduce, growth, pesticide, fertilizer, ...feebleSeeds, ...picoSeeds, ...basicSeeds];
    case ID_CHEST_ITEMS.CHEST_GOLD: // CHEST_GOLD
      return [...premiumProduce, growth, pesticide, fertilizer, ...picoSeeds, ...basicSeeds, ...premiumSeeds];
    default:
      return [];
  }
};

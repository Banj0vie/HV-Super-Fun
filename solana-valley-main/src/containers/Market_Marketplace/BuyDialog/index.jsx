...
const BuyDialog = ({ onBack, onClose }) => {
  ...
  const filteredItems = useMemo(() => {
    ...
    console.log("🚀 ~ BuyDialog ~ marketplaceItems:", marketplaceItems, filtered);
    // Apply search filter
    if (searchTerm.trim()) {
  ...
  const handleCancel = async item => {
    ...
    try {
      ...
      await Promise.all([getAllListings(), refetchItems()]);
    } catch (error) {
      ...
      <div className="buy-dialog-content">
        ...
        <CardView className="right-panel">
          ...
          <div className="pagination">
            <img src={buttonFrames.leftTriangleButton} alt="left" className="triangle-icon" onClick={onLeftPage} />
            <span>{currentPage}</span>
            <img src={buttonFrames.rightTriangleButton} alt="right" className="triangle-icon" onClick={onRightPage} />
          </div>
        </CardView>
      </div>

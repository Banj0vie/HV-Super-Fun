...
const SettingsDialog = ({ onClose }) => {
  ...
  // On-chain PDA/ATA init + reclaim removed (backend-driven architecture).

  return (
    <BaseDialog
      onClose={onClose}
      title="SETTINGS"
      header="/images/dialog/modal-header-setting.png"
      headerWidth={120}
      ...
      <div className="settings-dialog">
        <div className="settings-row-wrapper">
          <div className="settings-row">
            <div className="left">
              <img className="sound-icon" src="/images/settings/sound.png" alt="sound" />
            </div>
            <div className="right">
              <Slider
                min="0"
          ...
          <div className="settings-row">
            <div className="left">
              <img src="/images/settings/music.png" alt="music" />
            </div>
            <div className="right">
              <Slider
                min="0"

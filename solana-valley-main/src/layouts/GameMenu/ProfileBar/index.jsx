    ...
    <div className="profile-bar" style={{ display: isFarmMenu ? "none" : "flex" }}>
      ...
      <div className="profile-bar-content">
        <div className="profile-bar-content-top">
          ...
          />
          {/* Removed hidden on-chain test mint buttons (prodMint). */}
        </div>
        <div className="resource-badge" key={balanceKey}>
          <ProfileButton
            icon={<img alt="Locked Honey Balance" src="/images/profile_bar/locked_balance_icon.png" />}
      ...
      {isSettingsDialog && <SettingsDialog onClose={() => setIsSettingsDialog(false)}></SettingsDialog>}
    </div>
  );
};

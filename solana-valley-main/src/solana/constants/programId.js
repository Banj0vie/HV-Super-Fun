...
import { getClusterConfig, getFinalCluster, getRpcEndpoint, getWsEndpoint } from "../utils/clusterUtils";

export const TRESURY_WALLET = new PublicKey(process.env.REACT_APP_TRESURY_WALLET);
...
export const SOLANA_VALLEY_DEX_PROGRAM_ID =
  process.env.REACT_APP_SOLANA_VALLEY_DEX_PROGRAM_ID &&
  new PublicKey(process.env.REACT_APP_SOLANA_VALLEY_DEX_PROGRAM_ID); // new PublicKey('EVHHfpb4sarb9D2UWSXB6kkyWcS34hWTkd2qGEJhBJJe');
...
export const TOKEN_DECIMALS = Number(process.env.REACT_APP_TOKEN_DECIMALS);

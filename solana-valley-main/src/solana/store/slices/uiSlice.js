...
const numericSettings = new Set(["soundVolume", "musicVolume", "dexSlippage", "baseGwei"]);
...
export const selectNotificationsByType = (state, type) => state.ui.notifications.filter(n => n.type === type);

...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    updateEpochXP: (state, action) => {
      state.userData.epoch_xp = action.payload;
    },
    updateLastEpochCounted: (state, action) => {
      state.userData.last_epoch_counted = action.payload;
    },
    updateLockedTokens: (state, action) => {
      state.userData.locked_tokens = action.payload;
    },
    updateXTokenShare: (state, action) => {
      state.userData.xtoken_share = action.payload;
    },
    updateChestOpenTime: (state, action) => {
      state.userData.chest_open_time = action.payload;
    },
    updateLastWageTime: (state, action) => {
      state.userData.last_wage_time = action.payload;
    },
    updateLastHarvestTime: (state, action) => {
      state.userData.last_harvest_time = action.payload;
    },
    updateActivePlotIds: (state, action) => {
      state.userData.active_plot_ids = action.payload;
    },
    updateUserCrops: (state, action) => {
      state.userData.user_crops = action.payload;
    },
    updateSponsor: (state, action) => {
      state.userData.sponsor = action.payload;
    },
    updateAvatars: (state, action) => {
      state.userData.avatars = action.payload;
    },
    updateReferralCode: (state, action) => {
      state.userData.referral_code = action.payload;
    },

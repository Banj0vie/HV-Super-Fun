...
export const PRICE_FEeble = 1_000_000n;      // 1.0 HNY with 1e6 decimals
export const PRICE_PICO = 20_000_000n;       // 20.0 HNY with 1e6 decimals
export const PRICE_BASIC = 100_000_000n;     // 100.0 HNY with 1e6 decimals
export const PRICE_PREMIUM = 250_000_000n;   // 250.0 HNY with 1e6 decimals
